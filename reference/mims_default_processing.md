...
- data:
  ...
  from \`actiread::acti_read_gt3x()\`

- use_extrapolation:

  If \`TRUE\` the function will apply extrapolation algorithm to the
  input signal, otherwise it will skip extrapolation but only linearly
